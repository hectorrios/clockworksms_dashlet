...
//    }
    ...
    protected function logXML($log_msg, $xml) {
        ...
        // Output to Sugar Log
        $GLOBALS['log']->error("Clockwork $log_msg: $xml");
//        error_log("Clockwork $log_msg: $xml");
    ...
    protected function is_assoc($array) {
        /*
         * Hector Rios.
         * replace the array_filter with a more traditional foreach loop
         * so that a Sugar OnDemand environment will not complain.
         */
